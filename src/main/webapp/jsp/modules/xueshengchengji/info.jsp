            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生成绩登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="kechengziyuanName" name="kechengziyuanName" class="form-control"
                                                   v-model="ruleForm.kechengziyuanName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>课程封面</label>
                                        <img id="kechengziyuanPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>课程时间</label>
                                            <input style="width: 450px" id="kechengziyuanDate" name="kechengziyuanDate" class="form-control"
                                                   v-model="ruleForm.kechengziyuanDate" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengziyuanValue" name="kechengziyuanValue" class="form-control"
                                               v-model="ruleForm.kechengziyuanValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="kechengziyuanId" name="kechengziyuanId" v-model="ruleForm.kechengziyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xuefen" name="xuefen" class="form-control"
                                               v-model="ruleForm.xuefen" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueke" name="xueke" class="form-control"
                                               v-model="ruleForm.xueke" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.kechengziyuanContent != null && ruleForm.kechengziyuanContent != 'null' && ruleForm.kechengziyuanContent != '') {
            var kechengziyuanContentUeditor = UE.getEditor('kechengziyuanContentEditor');
                kechengziyuanContentUeditor.ready(function () {
                    ...
                    kechengziyuanContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.xueshengchengjiContent != null && ruleForm.xueshengchengjiContent != 'null' && ruleForm.xueshengchengjiContent != '') {
            var xueshengchengjiContentUeditor = UE.getEditor('xueshengchengjiContentEditor');
                xueshengchengjiContentUeditor.ready(function () {
                    ...
                    xueshengchengjiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
