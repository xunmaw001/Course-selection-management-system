...
<script>
    ...
    // 获取当前详情
    function getDetails() {
        var addxueshengxuanke = window.sessionStorage.getItem("addxueshengxuanke");
        if (addxueshengxuanke != null && addxueshengxuanke != "" && addxueshengxuanke != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("xueshengxuanke/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
